...
export default function AboutPage() {
	return (
		<main>
			...
			<div className={cn(textFont.className, "[&_p]:text-foreground/90 max-w-2xl space-y-4 leading-relaxed")}>
				<Text as="p">
				...
				<Text as="p">
					Если у вас есть вопросы или пожелания — загляните на страницу контактов, будем рады обратной связи.
				</Text>
			</div>
		</main>
	)
